...
(function() {
  ...
  angular
    ...
    .filter('encodeURIComponent', function() {
      ...
      return {
        restrict: 'EA',
        templateUrl: STATIC_URL + 'lib/app-catalog-common/action.html'
      };
  ...
  function commonInit($scope, $modal, toast, appCatalogModel) {
    ...
    var retired = function() {
      ...
      var modal = $modal.open({
        templateUrl: STATIC_URL + "lib/app-catalog-common/retired_panel.html",
        scope: newscope
      });
...
//FIXME probably belongs in its own directive...
  ...
  function appCatalogMagicSearchBar(basePath) {
    var directive = {
      ...
      restrict: 'E',
      templateUrl: STATIC_URL + "lib/app-catalog-common/magic_search.html"
    };
    return directive;
  }
  ...
  function appCatalogTableCtrl($scope, $http, $timeout, $modal, toast, appCatalogModel) {
    ...
    $scope.details = function(asset) {
      ...
      var modal = $modal.open({
        templateUrl: STATIC_URL + "lib/app-catalog-common/details_panel.html",
        scope: newscope
      });
      newscope.cancel = function() {
        modal.dismiss('');
